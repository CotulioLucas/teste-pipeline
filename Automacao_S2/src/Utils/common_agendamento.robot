...
E selecionar o produto com a unidade diferente
    ...
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.CAMPO_SELECIONAR_PRODUTO}
    Press Keys
    ...    None
    ...    ${DADOS_PROCEDIMENTO.TIPO_CONSULTA}
    Press Keys    None    RETURN
    Wait Until Element Is Not Visible    ${BUSCAR_PACIENTE_AGENDAMENTO.TELA_CARREGAMENTO}
    Press Keys    None    TAB
    Wait Until Keyword Succeeds
    ...
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.CAMPO_SELECIONAR_UNIDADE}
    Press Keys
    ...    None
    ...    ${DADOS_UNIDADES.OUTRA_UNIDADE}
    Press Keys    None    RETURN
    Wait Until Element Is Not Visible    ${BUSCAR_PACIENTE_AGENDAMENTO.TELA_CARREGAMENTO}
...
E realizar agendamento
    ...
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.BTN_CONFIRMA_AGENDAMENTO}
    Wait Until Element Is Visible    ${BUSCAR_PACIENTE_AGENDAMENTO.MODAL_RESTICAO_PRODUTO}
    Wait Until Keyword Succeeds
    ...    3x
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.BTN_CONTINUA_AGENDAMENTO}
...
E excluir um agendamento
    ...
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.BTN_EXCLUI_AGENDAMENTO}
    Wait Until Element Is Visible    ${BUSCAR_PACIENTE_AGENDAMENTO.MODAL_RESTICAO_PRODUTO}
    Wait Until Keyword Succeeds
    ...    3x
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.CAMPO_MOTIVO_CANCELAMENTO}
    Press Keys    None    TAB
    Wait Until Keyword Succeeds
    ...    3x
    ...    20s
    ...    Click Element
    ...    ${BUSCAR_PACIENTE_AGENDAMENTO.BTN_CONFIRMA_CANCELAMENTO}
    Wait Until Element Is Visible    ${BUSCAR_PACIENTE_AGENDAMENTO.POP_UP_MENSAGEM}
